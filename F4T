...
AAR.push(index)}
XD = AAR.slice(-1);
var Supporter = document.getElementsByClassName('sc-hORach hXxtlH')[0].childNodes[0].childNodes[XD[0]];
var htmlChunck = Supporter.innerHTML;
var add = htmlChunck.replace('><button typeof="link"','><div class="overlay supporter" style="display: block;"><div class="block"></div></div><button typeof="link"');
var remove = htmlChunck.replace('><div class="overlay supporter" style="display: block;"><div class="block"></div></div><button typeof="link"','><button typeof="link"')
var checkBox = document.getElementById("check2");
if (checkBox.checked == true){
   Supporter.innerHTML = add;
  } else {
   Supporter.innerHTML = remove;
  }
